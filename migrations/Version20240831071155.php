 ...
 */
final class Version20240831071155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_8BF21CDE6CC064FC ON property (broker_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_8BF21CDE6CC064FC ON property');
